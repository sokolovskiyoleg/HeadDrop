...
public class UpdateAPI {
    public boolean hasGithubUpdate(String owner, String repository) {
        try {
            java.net.HttpURLConnection connection = (java.net.HttpURLConnection) URI.create(
                    "https://api.github.com/repos/" + owner + "/" + repository + "/releases/latest").toURL()
                    .openConnection();
    ...
    public boolean hasSpigotUpdate(String resourceId) {
        ...
        try {
            java.net.HttpURLConnection connection = (java.net.HttpURLConnection) URI
                    .create("https://api.spigotmc.org/legacy/update.php?resource=" + resourceId).toURL()
                    .openConnection();
            connection.setRequestMethod("GET");
            connection.setRequestProperty("User-Agent", "HeadDrop");
